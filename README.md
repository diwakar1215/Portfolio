# 🚀 Diwakar Singh's 3D Developer Portfolio

![3D portfolio preview](./screenshot.png)
...
> Live preview: https://diwakarsingh.netlify.app/
...
```bash
git clone https://github.com/diwakar1215/diwakar-portfolio.git
